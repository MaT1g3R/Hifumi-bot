...
from .settings import COLOUR, NAME, DEVS, HELPERS, DEFAULT_PREFIX, \
    ...
    ENABLE_CONSOLE_LOGGING, SAFE_SHUTDOWN
...
__all__ = ['COLOUR', 'NAME', 'DEVS', 'HELPERS', 'DEFAULT_PREFIX', 'SUPPORT',
           ...
           'DANBOORU_USERNAME', 'DANBOORU_API', 'BAD_WORD', 'SHARDED',
           'SHARD_ID', 'SHARD_COUNT', 'ENABLE_CONSOLE_LOGGING', 'SAFE_SHUTDOWN',
           'IS_WINDOWS', 'IS_MAC', 'IS_LINUX', 'SYSTEM_OK', 'IS_64BIT',
           'PYTHON_OK']
